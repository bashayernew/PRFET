...
export async function GET(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  // Count a profile view (not self-views).
  if (viewer && viewer !== id) {
  ...
  let coordsVisible = u.isPremium && u.shareLocation;
  ...
  return NextResponse.json({
    user: {
      ...
      isPremium: u.isPremium, textColor: u.textColor, gender: u.gender, nationality: u.nationality,
